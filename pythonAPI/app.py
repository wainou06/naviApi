...
SELECT 
    o.userId AS user_id,
    oi.itemId AS item_id,
    CAST(SUM(o.rating) AS UNSIGNED) AS rating
FROM ratings o, priceproposals oi
where o.priceproposalId = oi.id
group by oi.itemId, o.userId
order by o.userId, oi.itemId;
"""
...
matrix = coo_matrix((data['rating'], (data['user_idx'], data['item_idx'])))
